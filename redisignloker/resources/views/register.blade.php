      ...
      <div class="row">
        ...
        background: linear-gradient(90deg, rgba(5,175,212,1) 0%, rgba(162,163,181,1) 100%); height: 100%;">
          <div class="d-flex align-items-center h-custom-2 px-5 ms-xl-4 mt-5 pt-5 pt-xl-0 mt-xl-n5" >
            ...
            <form style="width: 23rem;" class="text-white" action="" method="">

              <h3 class="fw-normal" style="letter-spacing: 1px;">Create Account</h3><br>

              <div class="form-outline mb-4">
                <label class="form-label" for="username" >username</label>
                <input type="text" name="username" class="form-control form-control-lg" placeholder="Example123"/>
              </div>

              <div class="form-outline mb-4">
                <label class="form-label" for="form2Example18">Email*</label>
                <input type="email" id="form2Example18" class="form-control form-control-lg" placeholder="Example@gmail.com" />
              </div>

              <div class="form-outline mb-4">
                <label class="form-label" for="form2Example28">Password*</label>
                <input type="password" id="form2Example28" class="form-control form-control-lg" placeholder="************" />
              </div>

              <div class="pt-1 mb-4">
                <button class="btn btn-primary btn-lg btn-block" type="button">Created Account</button>
              </div>
              ...
              <center>
                <p style="color: white; font-weight:bold;">Don't have an account? <a href="#!"  style="color: #00499E;font-weight:bold;">Sign up</a></p>
              </center>
